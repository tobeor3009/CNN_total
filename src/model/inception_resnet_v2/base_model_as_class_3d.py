...
class InceptionResnetBlock(layers.Layer):
    def __init__(self, scale, block_type,
        ...
        if block_type == 'block35':
            branch_0 = Conv3DBN(block_size * 2, 1,
                                groups=groups, activation=activation)
            branch_1_1 = Conv3DBN(block_size * 2, 1,
                                  groups=groups, activation=activation)
            branch_1_2 = Conv3DBN(block_size * 2, 3,
                                  groups=groups, activation=activation)
            branch_1 = Sequential([branch_1_1,
                                   branch_1_2])
            branch_2_1 = Conv3DBN(block_size * 2, 1,
                                  groups=groups, activation=activation)
            branch_2_2 = Conv3DBN(block_size * 3, 3,
                                  groups=groups, activation=activation)
            branch_2_3 = Conv3DBN(block_size * 4, 3,
                                  groups=groups, activation=activation)
            ...
            branch_0 = Conv3DBN(block_size * 12, 1,
                                groups=groups, activation=activation)
            branch_1_1 = Conv3DBN(block_size * 8, 1,
                                  groups=groups, activation=activation)
            branch_1_2 = Conv3DBN(block_size * 10, [1, 1, 7],
                                  groups=groups, activation=activation)
            branch_1_3 = Conv3DBN(block_size * 10, [1, 7, 1],
                                  groups=groups, activation=activation)
            branch_1_4 = Conv3DBN(block_size * 10, [7, 1, 1],
                                  groups=groups, activation=activation)
            branch_1 = Sequential([branch_1_1,
                                   branch_1_2,
                                   branch_1_3,
            ...
            branch_0 = Conv3DBN(block_size * 12, 1,
                                groups=groups, activation=activation)
            branch_1_1 = Conv3DBN(block_size * 12, 1,
                                  groups=groups, activation=activation)
            branch_1_2 = Conv3DBN(block_size * 14, [1, 1, 3],
                                  groups=groups, activation=activation)
            branch_1_3 = Conv3DBN(block_size * 16, [1, 3, 1],
                                  groups=groups, activation=activation)
            branch_1_4 = Conv3DBN(block_size * 16, [3, 1, 1],
                                  groups=groups, activation=activation)
