...
from .layers import LayerArchive, TensorArchive, EncodeBlock, OverlapPatchEmbed
from .layers import custom_init_layer_norm, custom_init_dense, identity_layer


def PVT_V2_Segmetation(input_shape,
    ...
    for i in range(num_stage-1, -1, -1):
        upsample_layer = HighwayResnetDecoder(embed_dims[i], unsharp=True)
