...
def InceptionV3(
    ...
    branch1x1 = conv2d_bn(x, 192, 1, 1, normliazation=normliazation, activation=activation)

    branch7x7 = conv2d_bn(x, 128, 1, 1, normliazation=normliazation, activation=activation)
    branch7x7 = conv2d_bn(branch7x7, 128, 1, 7, normliazation=normliazation, activation=activation)
    branch7x7 = conv2d_bn(branch7x7, 192, 7, 1, normliazation=normliazation, activation=activation)

    branch7x7dbl = conv2d_bn(x, 128, 1, 1, normliazation=normliazation, activation=activation)
    ...
    for i in range(2):
        ...
        branch7x7 = conv2d_bn(x, 160, 1, 1, normliazation=normliazation, activation=activation)
        branch7x7 = conv2d_bn(branch7x7, 160, 1, 7,
                              normliazation=normliazation, activation=activation)
        branch7x7 = conv2d_bn(branch7x7, 192, 7, 1,
                              normliazation=normliazation, activation=activation)

        branch7x7dbl = conv2d_bn(x, 160, 1, 1, normliazation=normliazation, activation=activation)
    ...
    branch7x7 = conv2d_bn(x, 192, 1, 1, normliazation=normliazation, activation=activation)
    branch7x7 = conv2d_bn(branch7x7, 192, 1, 7, normliazation=normliazation, activation=activation)
    branch7x7 = conv2d_bn(branch7x7, 192, 7, 1, normliazation=normliazation, activation=activation)

    branch7x7dbl = conv2d_bn(x, 192, 1, 1, normliazation=normliazation, activation=activation)
    ...
    branch3x3 = conv2d_bn(x, 192, 1, 1, normliazation=normliazation, activation=activation)
    branch3x3 = conv2d_bn(branch3x3, 320, 3, 3,
                          strides=(2, 2), padding='valid', normliazation=normliazation, activation=activation)

    branch7x7x3 = conv2d_bn(x, 192, 1, 1, normliazation=normliazation, activation=activation)
    ...
    for i in range(2):
        branch1x1 = conv2d_bn(x, 320, 1, 1, normliazation=normliazation, activation=activation)

        branch3x3 = conv2d_bn(x, 384, 1, 1, normliazation=normliazation, activation=activation)
