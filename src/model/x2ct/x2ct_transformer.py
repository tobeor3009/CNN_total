...
def inceptionv3(input_tensor, block_size,
    ...
    num_patch = utils.get_image_patch_num_2d(input_size[0:2],
                                             patch_size,
                                             stride_size)
    ...
    x = transformer_layers.PatchEmbedding(np.prod(num_patch),
                                          block_size * 4)(x)

    x = swin_layers.SwinTransformerBlock(block_size * 4, num_patch, num_heads=2,
                                         window_size=16, shift_size=8, num_mlp=num_mlp, act=act, norm=NORM_LAYER,
                                         swin_v2=swin_v2, name="depth_1_1")(x)
    x = transformer_layers.PatchMerging(num_patch, block_size * 4,
    ...
    if return_2d:
        skip1 = convert_1d_2d(x, num_patch)
    else:
        skip1 = x

    # previous: strides=(2, 2)
    x = swin_layers.SwinTransformerBlock(block_size * 8, num_patch, num_heads=2,
                                         window_size=16, shift_size=8, num_mlp=num_mlp, act=act, norm=NORM_LAYER,
                                         swin_v2=swin_v2, fit_dim=True, name="depth_2_1")(x)
    x = swin_layers.SwinTransformerBlock(block_size * 16, num_patch, num_heads=2,
                                         window_size=16, shift_size=8, num_mlp=num_mlp, act=act, norm=NORM_LAYER,
                                         swin_v2=swin_v2, fit_dim=True, name="depth_2_2")(x)
    x = transformer_layers.PatchMerging(num_patch, block_size * 16,
                                        norm=NORM_LAYER, swin_v2=swin_v2,
                                        name="down_2")(x)
    num_patch //= 2
    # mixed 0: 35 x 35 x 256
    branch1x1 = swin_layers.SwinTransformerBlock(block_size * 8, num_patch, num_heads=2,
                                                 window_size=4, shift_size=2, num_mlp=num_mlp, act=act, norm=NORM_LAYER,
                                                 swin_v2=swin_v2, fit_dim=True, name="depth_3_1_1")(x)

    branch5x5 = swin_layers.SwinTransformerBlock(block_size * 6, num_patch, num_heads=2,
                                                 window_size=4, shift_size=2, num_mlp=num_mlp, act=act, norm=NORM_LAYER,
                                                 swin_v2=swin_v2, fit_dim=True, name="depth_3_2_1")(x)
    branch5x5 = swin_layers.SwinTransformerBlock(block_size * 8, num_patch, num_heads=2,
                                                 window_size=16, shift_size=8, num_mlp=num_mlp, act=act, norm=NORM_LAYER,
                                                 swin_v2=swin_v2, fit_dim=True, name="depth_3_2_1")(branch5x5)

    branch3x3dbl = swin_layers.SwinTransformerBlock(block_size * 8, num_patch, num_heads=2,
                                                    window_size=4, shift_size=2, num_mlp=num_mlp, act=act, norm=NORM_LAYER,
                                                    swin_v2=swin_v2, fit_dim=True, name="depth_3_3_1")(x)
    branch3x3dbl = swin_layers.SwinTransformerBlock(block_size * 12, num_patch, num_heads=2,
    ...
    branch_pool = avg_pool(x, num_patch, strides=1)
    branch_pool = swin_layers.SwinTransformerBlock(block_size * 4, num_patch, num_heads=2,
                                                   window_size=8, shift_size=4, num_mlp=num_mlp, act=act, norm=NORM_LAYER,
    ...
    branch_pool = avg_pool(x, num_patch, strides=1)
    branch_pool = swin_layers.SwinTransformerBlock(block_size * 8, num_patch, num_heads=2,
                                                   window_size=4, shift_size=2, num_mlp=num_mlp, act=act, norm=NORM_LAYER,
...
# skip2.shape = [B, 128, 128, ?]
    if return_2d:
        skip2 = convert_1d_2d(x, num_patch)
    else:
        skip2 = x
    # mixed 3: 17 x 17 x 768
    branch3x3 = transformer_layers.PatchMerging(num_patch, block_size * 48,
                                                norm=NORM_LAYER, swin_v2=swin_v2,
                                                name="down_3_1")(x)
    branch3x3dbl = swin_layers.SwinTransformerBlock(block_size * 8, num_patch, num_heads=2,
                                                    window_size=4, shift_size=2, num_mlp=num_mlp, act=act, norm=NORM_LAYER,
    ...
    branch3x3dbl = transformer_layers.PatchMerging(num_patch, block_size * 12,
                                                   norm=NORM_LAYER, swin_v2=swin_v2,
                                                   name="down_3_2")(branch3x3dbl)

    branch_pool = max_pool(x, num_patch, strides=2)
    x = layers.concatenate(
    ...
    branch1x1 = swin_layers.SwinTransformerBlock(block_size * 24, num_patch, num_heads=4,
                                                 window_size=2, shift_size=1, num_mlp=num_mlp, act=act, norm=NORM_LAYER,
                                                 swin_v2=swin_v2, fit_dim=True, name="depth_4_14_1")(x)

    branch7x7 = swin_layers.SwinTransformerBlock(block_size * 16, num_patch, num_heads=4,
                                                 window_size=4, shift_size=2, num_mlp=num_mlp, act=act, norm=NORM_LAYER,
                                                 swin_v2=swin_v2, fit_dim=True, name="depth_4_15_1")(x)
    branch7x7 = swin_layers.SwinTransformerBlock(block_size * 16, num_patch, num_heads=8,
                                                 window_size=4, shift_size=2, num_mlp=num_mlp, act=act, norm=NORM_LAYER,
                                                 swin_v2=swin_v2, name="depth_4_15_2")(branch7x7)
    branch7x7 = swin_layers.SwinTransformerBlock(block_size * 16, num_patch, num_heads=2,
                                                 window_size=4, shift_size=2, num_mlp=num_mlp, act=act, norm=NORM_LAYER,
                                                 swin_v2=swin_v2, name="depth_4_15_3")(branch7x7)

    branch7x7dbl = swin_layers.SwinTransformerBlock(block_size * 16, num_patch, num_heads=4,
                                                    window_size=2, shift_size=1, num_mlp=num_mlp, act=act, norm=NORM_LAYER,
                                                    swin_v2=swin_v2, fit_dim=True, name="depth_4_16_1")(x)
    branch7x7dbl = swin_layers.SwinTransformerBlock(block_size * 16, num_patch, num_heads=8,
                                                    window_size=4, shift_size=2, num_mlp=num_mlp, act=act, norm=NORM_LAYER,
                                                    swin_v2=swin_v2, name="depth_4_16_2")(branch7x7dbl)
    branch7x7dbl = swin_layers.SwinTransformerBlock(block_size * 16, num_patch, num_heads=2,
                                                    window_size=4, shift_size=2, num_mlp=num_mlp, act=act, norm=NORM_LAYER,
                                                    swin_v2=swin_v2, name="depth_4_16_3")(branch7x7dbl)
    branch7x7dbl = swin_layers.SwinTransformerBlock(block_size * 16, num_patch, num_heads=8,
                                                    window_size=4, shift_size=2, num_mlp=num_mlp, act=act, norm=NORM_LAYER,
                                                    swin_v2=swin_v2, name="depth_4_16_4")(branch7x7dbl)
    branch7x7dbl = swin_layers.SwinTransformerBlock(block_size * 24, num_patch, num_heads=2,
                                                    window_size=4, shift_size=2, num_mlp=num_mlp, act=act, norm=NORM_LAYER,
                                                    swin_v2=swin_v2, fit_dim=True, name="depth_4_16_5")(branch7x7dbl)

    branch_pool = avg_pool(x, num_patch, strides=1)
    branch_pool = swin_layers.SwinTransformerBlock(block_size * 24, num_patch, num_heads=4,
                                                   window_size=2, shift_size=1, num_mlp=num_mlp, act=act, norm=NORM_LAYER,
    ...
    for layer_idx, idx in enumerate(range(18, 20)):
        ...
        branch7x7 = swin_layers.SwinTransformerBlock(block_size * 20, num_patch, num_heads=4,
                                                     window_size=2, shift_size=1, num_mlp=num_mlp, act=act, norm=NORM_LAYER,
                                                     swin_v2=swin_v2, fit_dim=True, name=f"depth_4_{idx}_2")(x)
        branch7x7 = swin_layers.SwinTransformerBlock(block_size * 20, num_patch, num_heads=5,
                                                     window_size=4, shift_size=2, num_mlp=num_mlp, act=act, norm=NORM_LAYER,
                                                     swin_v2=swin_v2, name=f"depth_4_{idx}_3")(branch7x7)
        branch7x7 = swin_layers.SwinTransformerBlock(block_size * 24, num_patch, num_heads=2,
                                                     window_size=4, shift_size=2, num_mlp=num_mlp, act=act, norm=NORM_LAYER,
                                                     swin_v2=swin_v2, fit_dim=True, name=f"depth_4_{idx}_4")(branch7x7)

        branch7x7dbl = swin_layers.SwinTransformerBlock(block_size * 20, num_patch, num_heads=4,
                                                        window_size=2, shift_size=1, num_mlp=num_mlp, act=act, norm=NORM_LAYER,
                                                        swin_v2=swin_v2, fit_dim=True, name=f"depth_4_{idx}_5")(x)
        branch7x7dbl = swin_layers.SwinTransformerBlock(block_size * 20, num_patch, num_heads=5,
                                                        window_size=4, shift_size=2, num_mlp=num_mlp, act=act, norm=NORM_LAYER,
                                                        swin_v2=swin_v2, name=f"depth_4_{idx}_6")(branch7x7dbl)
        branch7x7dbl = swin_layers.SwinTransformerBlock(block_size * 20, num_patch, num_heads=2,
                                                        window_size=4, shift_size=2, num_mlp=num_mlp, act=act, norm=NORM_LAYER,
    ...
    branch7x7 = swin_layers.SwinTransformerBlock(block_size * 24, num_patch, num_heads=4,
                                                 window_size=2, shift_size=1, num_mlp=num_mlp, act=act, norm=NORM_LAYER,
                                                 swin_v2=swin_v2, fit_dim=True, name="depth_4_20_1")(x)
    branch7x7 = swin_layers.SwinTransformerBlock(block_size * 24, num_patch, num_heads=8,
                                                 window_size=4, shift_size=2, num_mlp=num_mlp, act=act, norm=NORM_LAYER,
    ...
    branch7x7dbl = swin_layers.SwinTransformerBlock(block_size * 24, num_patch, num_heads=4,
                                                    window_size=2, shift_size=1, num_mlp=num_mlp, act=act, norm=NORM_LAYER,
                                                    swin_v2=swin_v2, fit_dim=True, name="depth_4_21_1")(x)
    branch7x7dbl = swin_layers.SwinTransformerBlock(block_size * 24, num_patch, num_heads=8,
                                                    window_size=4, shift_size=2, num_mlp=num_mlp, act=act, norm=NORM_LAYER,
    ...
    # skip3.shape = [B, 64, 64, ?]
    if return_2d:
        skip3 = convert_1d_2d(x, num_patch)
    else:
        skip3 = x
    # mixed 8: 8 x 8 x 1280
    branch3x3 = swin_layers.SwinTransformerBlock(block_size * 24, num_patch, num_heads=4,
                                                 window_size=2, shift_size=1, num_mlp=num_mlp, act=act, norm=NORM_LAYER,
                                                 swin_v2=swin_v2, fit_dim=True, name="depth_4_23_1")(x)
    branch3x3 = transformer_layers.PatchMerging(num_patch, block_size * 40,
                                                norm=NORM_LAYER, swin_v2=swin_v2,
                                                name="down_4_1")(branch3x3)

    branch7x7x3 = swin_layers.SwinTransformerBlock(block_size * 24, num_patch, num_heads=4,
                                                   window_size=2, shift_size=1, num_mlp=num_mlp, act=act, norm=NORM_LAYER,
                                                   swin_v2=swin_v2, fit_dim=True, name="depth_4_24_1")(x)
    branch7x7x3 = swin_layers.SwinTransformerBlock(block_size * 24, num_patch, num_heads=8,
                                                   window_size=2, shift_size=1, num_mlp=num_mlp, act=act, norm=NORM_LAYER,
                                                   swin_v2=swin_v2, name="depth_4_24_2")(branch7x7x3)
    branch7x7x3 = swin_layers.SwinTransformerBlock(block_size * 24, num_patch, num_heads=2,
                                                   window_size=2, shift_size=1, num_mlp=num_mlp, act=act, norm=NORM_LAYER,
                                                   swin_v2=swin_v2, name="depth_4_24_3")(branch7x7x3)
    branch7x7x3 = transformer_layers.PatchMerging(num_patch, block_size * 24,
                                                  norm=NORM_LAYER, swin_v2=swin_v2,
    ...
    for layer_idx, idx in enumerate(range(25, 28)):
        branch1x1 = swin_layers.SwinTransformerBlock(block_size * 40, num_patch, num_heads=8,
                                                     window_size=2, shift_size=1, num_mlp=num_mlp, act=act, norm=NORM_LAYER,
                                                     swin_v2=swin_v2, fit_dim=True, name=f"depth_4_{idx}_1")(x)

        branch3x3 = swin_layers.SwinTransformerBlock(block_size * 48, num_patch, num_heads=8,
                                                     window_size=2, shift_size=1, num_mlp=num_mlp, act=act, norm=NORM_LAYER,
                                                     swin_v2=swin_v2, fit_dim=True, name=f"depth_4_{idx}_2")(x)
        branch3x3_1 = swin_layers.SwinTransformerBlock(block_size * 48, num_patch, num_heads=4,
                                                       window_size=4, shift_size=2, num_mlp=num_mlp, act=act, norm=NORM_LAYER,
                                                       swin_v2=swin_v2, name=f"depth_4_{idx}_3")(branch3x3)
        branch3x3_2 = swin_layers.SwinTransformerBlock(block_size * 48, num_patch, num_heads=16,
                                                       window_size=4, shift_size=2, num_mlp=num_mlp, act=act, norm=NORM_LAYER,
        ...
        branch3x3dbl = swin_layers.SwinTransformerBlock(block_size * 56, num_patch, num_heads=8,
                                                        window_size=2, shift_size=1, num_mlp=num_mlp, act=act, norm=NORM_LAYER,
                                                        swin_v2=swin_v2, fit_dim=True, name=f"depth_4_{idx}_5")(x)
        branch3x3dbl = swin_layers.SwinTransformerBlock(block_size * 56, num_patch, num_heads=8,
                                                        window_size=4, shift_size=2, num_mlp=num_mlp, act=act, norm=NORM_LAYER,
                                                        swin_v2=swin_v2, name=f"depth_4_{idx}_6")(branch3x3dbl)
        branch3x3dbl_1 = swin_layers.SwinTransformerBlock(block_size * 56, num_patch, num_heads=4,
                                                          window_size=4, shift_size=2, num_mlp=num_mlp, act=act, norm=NORM_LAYER,
                                                          swin_v2=swin_v2, name=f"depth_4_{idx}_7")(branch3x3dbl)
        branch3x3dbl_2 = swin_layers.SwinTransformerBlock(block_size * 56, num_patch, num_heads=16,
                                                          window_size=4, shift_size=2, num_mlp=num_mlp, act=act, norm=NORM_LAYER,
