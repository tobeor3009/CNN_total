...
class CycleGan(Model):
    ...
    def train_step(self, batch_data):
        ...
        cliped_disc_X_grads = self.active_gradient_clipping(
            disc_X_grads, self.discriminator_X.trainable_variables)
        cliped_disc_Y_grads = self.active_gradient_clipping(
        ...
        cliped_gen_G_grads = self.active_gradient_clipping(
            gen_G_grads, self.generator_G.trainable_variables)
        cliped_gen_F_grads = self.active_gradient_clipping(
