...
def get_diff_label(label_tensor):
    ...
    label_origin = tf.argmax(label_tensor, axis=1)
...
class ATTGan(Model):
    ...
    def compile(
        ...
        ssim_loss_fn=base_ssim_loss_fn,
    ...
    def train_step(self, batch_data):
        ...
        # =================================================================================== #
        real_x, label_x, label_y = batch_data
        ...
        with tf.GradientTape(persistent=True) as gen_tape:
            ...
            ssim_loss = backend.mean(self.ssim_loss_fn(real_x, same_x))
