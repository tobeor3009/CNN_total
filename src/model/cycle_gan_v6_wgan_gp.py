    ...
    def train_step(self, batch_data):
        ...
        with tf.GradientTape(persistent=True, watch_accessed_variables=True) as disc_tape:
            ...
            if self.identity_loss is True:
                ...
                disc_X_identity_loss = to_fake_wasserstein_loss(disc_same_x)
                disc_Y_identity_loss = to_fake_wasserstein_loss(disc_same_y)
        ...
        with tf.GradientTape(persistent=True, watch_accessed_variables=True) as gen_tape:
            ...
            if self.identity_loss is True:
                ...
                gen_G_identity_disc_loss = to_real_wasserstein_loss(
                    disc_same_y)
                gen_F_identity_disc_loss = to_real_wasserstein_loss(
                    disc_same_x)
            else:
            ...
            gen_G_fake_disc_loss = to_real_wasserstein_loss(disc_fake_y)
            gen_F_fake_disc_loss = to_real_wasserstein_loss(disc_fake_x)
            gen_G_cycle_disc_loss = to_real_wasserstein_loss(disc_cycle_y)
            gen_F_cycle_disc_loss = to_real_wasserstein_loss(disc_cycle_x)
