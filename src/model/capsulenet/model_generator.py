...
from . layers import CapsuleLayer, PrimaryCap, Length, Mask

K.set_image_data_format('channels_last')


def CapsNet(input_shape, n_class, routings, image_size="tiny"):
    """
    ...
    if image_size == "tiny":
        filters = 256
        kernel_size = 9
        primary_dim_capsule = 8
        primary_n_channels = 32
        primary_stride = 2
        dim_capsule = 16
        routings = 3
    ...
    conv1 = layers.Conv2D(filters=filters, kernel_size=kernel_size, strides=1,
                          padding='valid', activation='relu', name='conv1')(x)

    # Layer 2: Conv2D layer with `squash` activation, then reshape to [None, num_capsule, dim_capsule]
    primarycaps = PrimaryCap(conv1,
                             dim_capsule=primary_dim_capsule,
                             n_channels=primary_n_channels,
                             kernel_size=kernel_size, strides=primary_stride, padding='valid')
    ...
    decoder.add(layers.Dense(512, activation='relu', input_dim=dim_capsule * n_class))
