...
class _CoordinateChannel(Layer):
    ...
    def call(self, inputs, dtype=None, training=None, mask=None):
        ...
        if self.rank == 1:
            ...
            batch_shape, dim, channels = self.after_build_input_shape
        ...
        if self.rank == 2:
            ...
            xx_ones = tf.ones(shape=[batch_shape, dim2], dtype='int32')
            ...
            yy_ones = tf.ones(shape=[batch_shape, dim1], dtype='int32')
            ...
            outputs = K.concatenate(
                [inputs, xx_channels, yy_channels], axis=-1)
        ...
        if self.rank == 3:
            ...
            batch_shape, dim1, dim2, dim3, channels = self.after_build_input_shape
